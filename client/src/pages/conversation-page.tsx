        ...
        <div className="bg-white rounded-lg shadow-sm mb-4">
          <div className="p-4 flex items-center">
            ...
            <div className="flex items-center flex-1">
              ...
              />
              <div className="ml-3">
                <div className="font-heading font-medium text-gray-900">{otherUser.username}</div>
              ...
              <Dialog>
                ...
                <DialogContent>
                  <DialogHeader>
                    ...
                    <DialogDescription>
                      Keep track of your thoughts about {otherUser.username}. These notes are only visible to you.
                    </DialogDescription>
                  </DialogHeader>
                ...
                {isLoadingMessages ? (
                  ...
                  <div className="flex flex-col items-center justify-center h-full text-center">
                    ...
                    <p className="text-sm text-gray-400">
                      Send your first message to {otherUser.username}
                    </p>
                  </div>
                )}
              </div>
