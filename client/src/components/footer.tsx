...
export default function Footer() {
  ...
  // Don't show footer on call page
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center mb-6">
              <Logo />
              <span className="ml-2 text-white font-heading font-semibold text-xl">Kindred</span>
            </div>
            <p className="text-gray-400 mb-6">
              Building meaningful connections through conversations first, appearance second.
            </p>
